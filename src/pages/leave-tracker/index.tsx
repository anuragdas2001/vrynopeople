...
const LeaveTracker = () => {
  ...
  const getColors = (type) => {
    switch (type) {
      case "Casual Leave":
        return { bg: "bg-blue-50", text: "text-blue-600", progress: "bg-blue-500" };
      case "Earned Leave":
        return { bg: "bg-emerald-50", text: "text-emerald-600", progress: "bg-emerald-500" };
      case "Leave Without Pay":
        return { bg: "bg-rose-50", text: "text-rose-600", progress: "bg-rose-500" };
      case "Paternity Leave":
        return { bg: "bg-amber-50", text: "text-amber-600", progress: "bg-amber-500" };
      case "Sabbatical Leave":
        return { bg: "bg-orange-50", text: "text-orange-600", progress: "bg-orange-500" };
      case "Sick Leave":
        return { bg: "bg-purple-50", text: "text-purple-600", progress: "bg-purple-500" };
      default:
        return { bg: "bg-gray-50", text: "text-gray-600", progress: "bg-gray-500" };
    }
  };
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-6">
                <div className="bg-white/20 rounded-xl p-4">
                  ...
                  <p className="text-2xl font-bold text-white">{totalAvailable} days</p>
                </div>
                <div className="bg-white/20 rounded-xl p-4">
                  <p className="text-white/70 text-sm">Booked Leave</p>
                  <p className="text-2xl font-bold text-white">{totalBooked} days</p>
                </div>
              </div>
            </div>
              ...
              <CardContent className="space-y-4">
                <div className="flex justify-between items-center">
                  <div>
                    ...
                    <p className={`text-xl font-bold ${text}`}>{leave.available}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-500">Booked</p>
                    <p className="text-xl font-bold text-gray-700">{leave.booked}</p>
                  </div>
                </div>
                <div className="space-y-2">
                  <Progress value={percentageUsed} className="h-2" indicatorClassName={progress} />
